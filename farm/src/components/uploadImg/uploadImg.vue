  ...
  <div class='finish_room'>
    <div class='finish_room2'>
     <div v-for='(item ,index ) in imgs' class='room_img'>
      <img :src="item">
      <span @click='delete_img(index)'><img style="width: 24px;height: 24px;" :src="del"></span>
    </div>
    <div class='room_add_img'>
      <span><img width="32" height="32" :src="add"></span>
      <span>上传图片</span>
...
<script >
  import add from './icon-img-add.png'
  import del from './icon-img-del.png'
  export default{
    data () { 
      return{
        imgs:[],
